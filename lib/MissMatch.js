  ...
  function parseProperties(node) {
    ...
    while(true) {
      ...
      if(peek() === '.') {
        ...
        // Object properties must start with '.' or ':'
    ...
    if(hasNext()) {
      switch (peek()) {
        ...
        case 'd':
          ...
          break;
        case 'r':
          parseGeneric(AST,'regexobj');
          break;                  
        case '_':
          parseGeneric(AST, 'any');
          break;
        default:
          unexpectedTokenException('one of (a,o,n,s,b,f,d,r,_)');
      }
    }
...
mm.makeCompiler = function (AST) {
  ...
  function matchRegex(o) {
    return {
      result: is(o, '[object RegExp]'),
      param: o
    };
  }
