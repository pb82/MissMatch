    ...
    if(hasNext()) {
      switch (peek()) {
        ...
        case '_':
          ...
          break;
        default:
          unexpectedTokenException('(a,o,n,s,b,f,d,_)');
      }
    }
...
mm.makeCompiler = function (AST) {
  ...
  function curry(fun, args) {
    /**
     * There is always exactly one parameter that is passed in at runtime.
     */
    return function (x) {        
  ...
  function matchArray(m,a) {
     ...
     */
    if (!isArray(a) || (m.length > a.length)) {
      return result;
    }
