...
mm.makeCompiler = function (AST) {
   ...
   * f: the test function: there are two use cases: one that does
   *    include the prototype chain ond one that does not.
   */
  function testProperty(m,x,o,f) {
    var result = f();
    if(m.length) {
      /**
  ...
  function hasProperty(m,x,o) {
    return testProperty(m,x,o, function () {
